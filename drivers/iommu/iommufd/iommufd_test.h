...
/* Should not be equal to any defined value in enum iommu_dev_invalidate_data_type */
#define IOMMU_DEV_INVALIDATE_DATA_SELFTEST 0xdeadbeef
#define IOMMU_DEV_INVALIDATE_DATA_SELFTEST_INVALID 0xdadbeef

/**
 * struct iommu_dev_invalidate_selftest - Device Invalidation data for Mock driver
 ...
 */
struct iommu_dev_invalidate_selftest {
#define IOMMU_TEST_INVALIDATE_FLAG_ALL	(1 << 0)
	__u32 flags;
	__u32 cache_id;
};
